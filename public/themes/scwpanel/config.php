...
return array(
	...
	*/
	...
	'events' => array(
		...
		{
			$theme->setTitle('SCWPANEL');
			$theme->setAuthor('Everton Lima');
		},
		...
		'asset' => function($asset)
		{
			...
			/*
			$asset->cook('font-awesome', function($asset)
			{
				$asset->add('font-awesome', '//maxcdn.bootstrapcdn.com/font-awesome/4.2.0/css/font-awesome.min.css');
			});
			*/
